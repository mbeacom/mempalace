...
| `normalize.py` | Converts supported chat formats (Claude Code, GitHub Copilot CLI, Codex, Gemini, Pi, Claude.ai, ChatGPT, Continue, Slack, and plain text) to standard transcript format |
